...
L'employeur peut déroger, sous sa propre responsabilité, à la durée maximale quotidienne de huit heures lorsque les circonstances mentionnées à l'article [R. 3122-10][1] impliquent :   
...
S'il se trouve dans l'attente d'une réponse à une demande de dérogation, il informe immédiatement l'inspecteur du travail de l'obligation où il s'est trouvé d'anticiper la décision attendue et en donne les raisons.
 ...
 [1]: /affichCodeArticle.do?cidTexte=LEGITEXT000006072050&idArticle=LEGIARTI000018486487&dateTexte=&categorieLien=cid