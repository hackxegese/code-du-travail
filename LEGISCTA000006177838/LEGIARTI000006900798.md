...
Elles peuvent exercer ces actions en faveur d'un candidat à un emploi, à un stage ou une période de formation en entreprise ou d'un salarié dans les conditions prévues à [l'article L. 1134-1][1], sous réserve de justifier d'un accord écrit de l'intéressé.

L'intéressé peut toujours intervenir à l'instance engagée par l'association et y mettre un terme à tout moment.

 [1]: /affichCodeArticle.do?cidTexte=LEGITEXT000006072050&idArticle=LEGIARTI000006900795&dateTexte=&categorieLien=cid