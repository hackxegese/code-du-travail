...
Dans les entreprises dotées d'un comité central d'entreprise, l'employeur consulte le comité central et le ou les comités d'établissement intéressés dès lors que les mesures envisagées excèdent le pouvoir du ou des chefs d'établissement concernés ou portent sur plusieurs établissements simultanément. Dans ce cas, le ou les comités d'établissement tiennent leurs réunions après celles du comité central d'entreprise tenues en application de l'article [L. 1233-30][1]. Ces réunions ont lieu dans les délais prévus à l'article L. 1233-30. 
