...
L'entrepreneur de travail temporaire est considéré comme défaillant au sens de l'article [  
L'entrepreneur de travail temporaire est considéré comme défaillant au sens de l'article][1] lorsqu'à l'expiration d'un délai de quinze jours suivant la réception d'une mise en demeure, il n'a pas payé tout ou partie des dettes énumérées à l'article [L. 1251-49][2].   
...
L'entrepreneur de travail temporaire est également considéré comme défaillant lorsqu'il fait l'objet d'une procédure de sauvegarde, de redressement ou de liquidation judiciaire. Dans ce cas, le gérant est informé du jugement, dans les mêmes formes, par le mandataire judiciaire ou par le liquidateur.
 ...
 [2]: /affichCodeArticle.do?cidTexte=LEGITEXT000006072050&idArticle=LEGIARTI000006901305&dateTexte=&categorieLien=cid