...
Un organisme d'un Etat membre de l'Union européenne non établi en France peut effectuer de façon occasionnelle des prestations de service mentionnées à l'article [L. 4722-1][1] s'il dispose d'une accréditation attestant qu'il a été reconnu compétent pour mettre en œuvre toute méthode normalisée ou assimilée, applicable sur le territoire national, dans le domaine de compétence au titre duquel il intervient.

 [1]: /affichCodeArticle.do?cidTexte=LEGITEXT000006072050&idArticle=LEGIARTI000006903400&dateTexte=&categorieLien=cid