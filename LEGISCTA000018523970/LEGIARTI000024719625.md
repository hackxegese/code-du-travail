...
Sont réputées remplir la condition de compétence professionnelle exigée d'un maître d'apprentissage en application de l'article [Sont réputées remplir la condition de compétence professionnelle exigée d'un maître d'apprentissage en application de l'article][1] : 
...
Les stages et les périodes de formation effectués en milieu professionnel, dans le cadre d'une formation initiale ou continue qualifiante prévue à l'article [L. 6314-1][2], ne sont pas pris en compte dans le décompte de la durée d'expérience requise.
